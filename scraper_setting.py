...
http_header = {
            ...
            "Referer": "http://stats.ncaa.org/team/inst_team_list?academic_year=2016&conf_id=-1&division=11&sport_code=MFB",
            "Connection": "keep-alive",
            "Pragma": "no-cache",
            "Cache-Control": "no-cache"
            } # Variables from the HTTP header (default)

start_url = 'http://stats.ncaa.org/active_career_leaders/show_summary_from_rankings?academic_year=2016&division=11&sport_code=MFB=' + str(academic_year) + "&division=1" # URL to start from (Change this for different years). You can get this URL from http://stats.ncaa.org/team/inst_team_list?academic_year=2016&conf_id=-1&division=11&sport_code=MFB. This URL is for the 2015-2016 season.
